...
extension XcfMcpServer {
    ...
    /// Tool for creating a diff between two strings or from a document
    static let createDiffTool = Tool(
        name: "create_diff",
        description: "Create a diff between two strings or from a document",
        inputSchema: .object([
            McpConfig.typeKey: .string(McpConfig.objectType),
            McpConfig.propertiesKey: .object([
                "sourceString": .object([
                    McpConfig.typeKey: .string(McpConfig.stringType),
                    McpConfig.descriptionKey: .string("Original source string (optional if using filePath)")
                ]),
                "destString": .object([
                    McpConfig.typeKey: .string(McpConfig.stringType),
                ...
                "filePath": .object([
                    McpConfig.typeKey: .string(McpConfig.stringType),
                    McpConfig.descriptionKey: .string("Path to the source document (optional)")
                ]),
                "startLine": .object([
                    McpConfig.typeKey: .string(McpConfig.integerType),
                    McpConfig.descriptionKey: .string("Start line for partial document diff (optional)")
                ]),
                "endLine": .object([
                    McpConfig.typeKey: .string(McpConfig.integerType),
                    McpConfig.descriptionKey: .string("End line for partial document diff (optional)")
                ]),
                "entireFile": .object([
                    McpConfig.typeKey: .string(McpConfig.booleanType),
                    McpConfig.descriptionKey: .string("Use entire file for diff (optional)")
                ])
            ]),
            McpConfig.requiredKey: .array([.string("destString")])
        ])
    )
    
    /// Tool for applying a diff to a string or to a document
    static let applyDiffTool = Tool(
        name: "apply_diff",
        description: "Apply a diff to a source string or document",
        inputSchema: .object([
            McpConfig.typeKey: .string(McpConfig.objectType),
            McpConfig.propertiesKey: .object([
                "sourceString": .object([
                ...
                "destString": .object([
                    McpConfig.typeKey: .string(McpConfig.stringType),
                    McpConfig.descriptionKey: .string("Diff or destination string to apply")
                ]),
                "filePath": .object([
                    McpConfig.typeKey: .string(McpConfig.stringType),
                    McpConfig.descriptionKey: .string("Path to the source document (optional)")
                ...
                "startLine": .object([
                    McpConfig.typeKey: .string(McpConfig.integerType),
                    McpConfig.descriptionKey: .string("Start line for partial document patch (optional)")
                ]),
                "endLine": .object([
                    McpConfig.typeKey: .string(McpConfig.integerType),
                    McpConfig.descriptionKey: .string("End line for partial document patch (optional)")
                ]),
                "entireFile": .object([
                    McpConfig.typeKey: .string(McpConfig.booleanType),
                    McpConfig.descriptionKey: .string("Use entire file for patch (optional)")
                ])
            ]),
            McpConfig.requiredKey: .array([.string("destString")])
        ])
